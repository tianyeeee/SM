...
//            ArrayList<ArrayList<double[][]>> bldLayoutArr = shadowMatching.getBldLayout(bldModels, llo, llo, 2*gridRadius);
...
//                if (states.get(i)[5] < eps) states.get(i)[5] = 0;
            ...
            try {
                br = new BufferedWriter(new FileWriter("C:/Users/ye.sensewhere/Documents/new project on shadowing/D10192016/data/java/states_t24.csv", true));
        ...
        BufferedWriter br = null;
        try {
            br = new BufferedWriter(new FileWriter("C:/Users/ye.sensewhere/Documents/new project on shadowing/D10192016/data/java/lla_out_t24.csv"));
            StringBuilder sb = new StringBuilder();
